function [hdr_info] = mola_megdr_lbl2hdr(lbl_info)
...
if isempty(obj_image)
    ...
    if isempty(obj_map)
        ...
        [map_info,projection_info,coordinate_system_string] = mola_megdr_get_map_info_3396190_CM000(lbl_info);
